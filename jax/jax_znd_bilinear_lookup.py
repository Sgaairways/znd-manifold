...
Purpose
-------
Keep the existing SDToolbox-generated manifold and physical-x preprocessing,
...
def main():
    ...
    print("Physics/database:  unchanged cached SDToolbox manifold")
    ...
    print(
        ...
        "and the nine-point direct-truth NRMSE should reproduce the existing validation baseline."
    )
